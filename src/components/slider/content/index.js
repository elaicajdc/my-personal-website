  ...
  return (
    <ContentWrapper width={width} style={style}>
      <ContentContainer className="relative">
        ...
        <p>{description}</p>
        <a href={`${link}`}>
          <button type="button" class="mt-5 inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-white bg-black hover:bg-gray-600 transition ease-in-out duration-150 cursor-not-allowed" disabled="">
            {`View Project`}
          </button>
        </a>
      </ContentContainer>
